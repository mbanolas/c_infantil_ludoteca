...
(function ($) {
    ...
    Datagrid.prototype.checkCachedData = function () {
        ...
        // modificado por maba para evitar error de eliminar search
        // if (!isset(cachedDatra.search_text)) forceRefresh = true;
        // if (isset(cachedDatra.search_text) && cachedDatra.search_text.length > 0) {
    ...
    Datagrid.prototype.listenerColumnWithOrdering = function () {
        ...
        //$('.column-with-ordering').not('[data-order-by^="fecha"]').click(function () {
