...
class UsuariosLudoteca extends CI_Controller
{
    ...
    public function _usuariosLudotecas_output($output = null)
    {
    ...
    public function usuarios()
    {
        ...
        $crud
            ...
            ->set_subject('Inscripcions ludoteca')
            ->unset_clone()
            ->unset_read()
            // ->unset_delete()
            ;
        ...
        $crud
            ...
            ->display_as('fecha_nacimiento', 'Data de naixement')
            ...
            ->display_as('texto_id_actividad', 'Actividad:')
            ->display_as('texto_id_ludoteca', 'Ludoteca:')
            ...
            ->display_as('texto_id_tarjeta_t12', 'TÉ TARJETA DEL TRANSPORT T-12?')
            ...
            ->display_as('id_actividad','Activitat:')
        ...
        $crud
            ...
            ->set_relation('id_ludoteca', 'c_ludotecas', '{nombre_ludoteca}',array('id_curso'=>$ultimoCurso))
        ...
        $crud
            ...
            ->callback_field('texto_id_ludoteca', array($this, 'texto_callback'))
        ...
        if ($state == 'edit') {
            ...
            if (($key = array_search('id_ludoteca', $camposRequiered)) !== false) {
        ...
        if ($state == 'edit') {
            ...
            $jsEdit =   '<script> 
                                ...
                                if(pagado==1){
                                    ...
                                    $(\'select[name="id_ludoteca"]\').attr("disabled","disabled"); 
        ...
        $this->_usuariosLudotecas_output($output);
    }
    ...
    function validar_id_ludoteca($id_ludoteca,$texto){
        // mensaje('pagado '.$_POST['pagado']);
        $pagado=$_POST['pagado'];
        if($id_ludoteca>0) {
            return true;
       }
        $this->form_validation->set_message('validar_id_ludoteca', "Obligatorio seleccionar $texto.");
        return false;
    }
    ...
    function afterInsert($post_array, $primary_key='0'){
        ...
        $sql="SELECT c.num_curso as num_curso,  u.nombre_tutor as nombre_tutor FROM c_usuarios u
        LEFT JOIN c_ludotecas a ON a.num_ludoteca=u.id_ludoteca 
    ...
    function afterUpdate($post_array, $primary_key='0'){
        ...
        $hoy=date("Y-m-d"); 
        $usuario=$this->session->userdata('nombre');
        $query="SELECT c.num_curso as num_curso  FROM c_usuarios u
        LEFT JOIN c_ludotecas a ON a.num_ludoteca=u.id_ludoteca 
        LEFT JOIN c_cursos c ON c.num_curso=a.id_curso
        -- LEFT JOIN c_grupos g ON g.num_grupo=a.id_grupo
