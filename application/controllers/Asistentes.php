...
class Asistentes extends CI_Controller
{
    ...
    public function _asistentes_output($output = null)
    {
        $datos['casal']=getTituloCasalCorto();
        $this->load->view('templates/cabecera',$datos);
        $this->load->view('viewsTables/asistentes.php', (array)$output);
    ...
    function getAsistencias(){
        $resultado=$this->asistentes_model->getAsistencias($_POST['usuario'],$_POST['curso'],$_POST['actividades'],$_POST['trimestres']);
    ...
    public function asistentes(){
        ...
        $table = 'c_asistentes';
          ...
          $crud
            ->set_table($table)
            ->order_by('actividad')
            ->set_subject('Assistents activitats')
            ->unset_clone()
            ->unset_read()
            ->unset_delete()
            ->unset_add()
        ...
        $output = $crud->render();
        $this->_asistentes_output($output);
