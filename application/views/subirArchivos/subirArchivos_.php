...
<div class="card-deck">
  ...
  <div class="card ">
    ...
    <?php if ($error['error']) {
      ...
      echo '<span ><p class="btn-danger msgError">' . (($error['error'])) . $file . '</p></span>';
    } ?>
    <?php if ($exito['fileName']) {
      echo '<span ><p class="msgExito btn-success"> Archivo ' . $exito['fileName'] . ' subido correctamente</p></span>';
    } ?>
  ...
  <div class="card ">
    ...
    <div class="file-field medium">
        ...
        <div class="file-path-wrapper">
           <input class="file-path validate" type="text" placeholder="Archivo Jamonarium">
        </div>
    </div>
      ...
      <!-- Provides extra visual weight and identifies the primary action in a set of buttons -->
      <button type="button" class="btn btn-danger col-12 msgError">Error </button>
      <!-- Provides extra visual weight and identifies the primary action in a set of buttons -->
      <button type="button" class="btn btn-success "><i class="fa fa-upload" aria-hidden="true"></i> Subir archivo Jamonarium</button>
      <button type="button" class="btn btn-warning cancel-button"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Cancelar</button>
