...
<body>
    ...
    <div class="jumbotron">
        <h2 class="display-5">Informe Ajuntament</h2>
        <h3 class="display-8">Seleccionar dates</h3>
        <?php echo form_open('recibos/excelInformeAyuntamiento', array('class' => "form-horizontal", 'role' => "form")); ?>
        ...
        <button type="submit" id="bajarExcel" class="btn btn-primary">Baixar Excel Informe Ajuntament</button>
        <?php echo form_close(); ?>
