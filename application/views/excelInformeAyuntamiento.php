...
$this->excel->getActiveSheet()->getStyle('A13:J13')->applyFromArray($styleArrayMedium);
...
foreach($ingresos as $k=>$v){
    ...
    $this->excel->getActiveSheet()->setCellValue('B'.$row, $v['numeroRegistroCasal']);
    $this->excel->getActiveSheet()->setCellValue('C'.$row, strtoupper($v['dni_tutor']));
    $this->excel->getActiveSheet()->setCellValue('D'.$row, $v['actividades']);
    $this->excel->getActiveSheet()->setCellValue('E'.$row, $v['num_registo']);
    $this->excel->getActiveSheet()->setCellValue('F'.$row, $v['precio_hora']);
    $this->excel->getActiveSheet()->setCellValue('G'.$row, $v['importe_base']);
    ...
    $this->excel->getActiveSheet()->getStyle('A'.$row.':J'.$row)->applyFromArray($styleArrayThin);
    $row++;
}
    ...
    $this->excel->getActiveSheet()->getStyle('H'.$row.':I'.$row)->applyFromArray($styleArrayMedium);
