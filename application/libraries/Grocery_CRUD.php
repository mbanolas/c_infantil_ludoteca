...
class grocery_CRUD_Model_Driver extends grocery_CRUD_Field_Types
{
	...
	{
		log_message('INFO', '///////////////////////////////'.' '.'inicio set_ajax_list_queries '.date('h:i:s'));
				
		$field_types = $this->get_field_types();
		// foreach($field_types as $k=>$v)
		// 	log_message('INFO', "/////////////////////////////// $k".'  '.serialize($v).date('h:i:s'));
...
class Grocery_CRUD extends grocery_CRUD_States
{
	 ...
	 * maba
	 */
	public function set_columns_without_sorting($fields=array()){
		return $this;
	}
	/**
	 *
